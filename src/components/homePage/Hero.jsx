...
const Hero = () => {
    return (
        <div className="bg-[#0f1f18] px-5 rounded-2xl justify-center items-center relative z-0
         my-10 md:my-15 py-10 md:py-15 md:px-15 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-15  ">
